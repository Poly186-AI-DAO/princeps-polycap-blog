const siteMetadata = {
  title: 'Princeps Polycap — Systems For Abundance',
  ...
  twitter: 'https://twitter.com/PrincepsPolycap',
  x: 'https://x.com/PrincepsPolycap',
  linkedin: 'https://www.linkedin.com/in/princeps-polycap',
  peerlist: 'https://peerlist.io/princeps',
  youtube: 'https://youtube.com/@PrincepsPolycap',
  instagram: 'https://instagram.com/princepspolycap',
  tiktok: 'https://tiktok.com/@princeps_polycap',
  medium: 'https://medium.com/@princepspolycap',
  ...
  brandStrategy: {
    ...
    voiceTone: 'Self-aware, vulnerable, meta-textual, and brutally honest',
    primaryAudience: [
      'Aspiring founders',
      'Deep tech operators',
      'Sci-fi pragmatists',
